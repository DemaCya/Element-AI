            ...
            {!report.is_paid ? (
              ...
              <div className="relative">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 border border-purple-500/20 relative overflow-hidden">
                  ...
                  {/* 毛玻璃遮罩 - 只遮住下半部分 */}
                  <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-slate-800/100 via-slate-800/100 to-slate-800/99 backdrop-blur-2xl pointer-events-none"></div>
